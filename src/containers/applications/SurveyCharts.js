...
const workChartData = {
  labels: ['کارفرما هستم', 'کارمند هستم', 'دنبال شغل جدید', 'اخراج شدم'],
  datasets: [
    {
      label: '',
      borderColor: [
...
const SurveyCharts = () => {
  return (
    <Colxx xxs="12" lg="8">
      <Card className="mb-4">
        <CardBody>
          <CardTitle>چقدر سن داری؟</CardTitle>
      ...
      <Card className="mb-4">
        <CardBody>
          <CardTitle>جنسیت شما چیه؟</CardTitle>
          <div className="chart-container">
      ...
      <Card className="mb-4">
        <CardBody>
          <CardTitle>وضعیت شغلت درچه حاله؟</CardTitle>
          <div className="chart-container">
      ...
      <Card className="mb-4">
        <CardBody>
          <CardTitle>با چه زبانی کد میزنی؟</CardTitle>
          <div className="chart-container">
