...
module.exports = {
  ...
  'forms.EnrollmentType': 'د شمولیت ډول/ نوع شمولیت',
  ...
  'inst.file': 'عکس',
  'forms.StdInteranceTypeLabel': 'د شمولیت طریقه/ طریقه شمولیت',
  ...
  'forms.StdSchoolProvinceOptions_14': 'شهر کابل',
  'forms.StdSchoolProvinceOptions_15': 'کابل',
  'forms.StdSchoolProvinceOptions_16': 'کندهار',
  'forms.StdSchoolProvinceOptions_17': 'کاپیسا',
  'forms.StdSchoolProvinceOptions_18': 'خوست',
  'forms.StdSchoolProvinceOptions_19': 'کنر',
  'forms.StdSchoolProvinceOptions_20': 'کندز',
  'forms.StdSchoolProvinceOptions_21': 'لغمان',
  'forms.StdSchoolProvinceOptions_22': 'لوگر',
  'forms.StdSchoolProvinceOptions_23': 'ننگرهار',
  'forms.StdSchoolProvinceOptions_24': 'نیمروز',
  'forms.StdSchoolProvinceOptions_25': 'نورستان',
  'forms.StdSchoolProvinceOptions_26': 'پکتیا',
  'forms.StdSchoolProvinceOptions_27': 'پکتیکا',
  'forms.StdSchoolProvinceOptions_28': 'پنجشیر',
  'forms.StdSchoolProvinceOptions_29': 'پروان',
  'forms.StdSchoolProvinceOptions_30': 'سمنگان',
  'forms.StdSchoolProvinceOptions_31': 'سرپل',
  'forms.StdSchoolProvinceOptions_32': 'تخار',
  'forms.StdSchoolProvinceOptions_33': 'اروزگان',
  'forms.StdSchoolProvinceOptions_34': 'وردگ',
  'forms.StdSchoolProvinceOptions_35': 'زابل',
  ...
  'teacher.langOptions_4': 'پشتو و دری',
  'teacher.teachingLang': 'تدریسی ژبه/ زبان تدریسی',
  'teacher.teachingLangErr': 'تدریسی ژبه اړینه ده/ زبان تدریسی ضروری است',
  'teacher.appointmentTOptions_1': 'بالمقطع خارج تشکیل',
  'teacher.appointmentTOptions_2': 'بالمقطع داخل تشکیل',
  'teacher.appointmentTOptions_3': 'رسمی',
  ...
  'attendance.attendaceDisplayTitle': 'حاضری',
  ...
  'student.rejected-marks-update': 'د رد شویو نمرو اپدیت',
  ...
  'workshop.register': 'ورکشاپ ثبت کول / ثبت ورکشاپ',
  'needs.register': 'نیازسنجی ثبت کول / ثبت نیازسنجی',
  'class.list': 'د صنف لیست / لیست صنف',
  'menu.evaluation': 'ارزیابی',
  'menu.workshop': 'ورکشاپ',
  'menu.needs': 'نیازسنجی',
  'menu.second-chance-marks-register': 'د دویم چانس د نومرو ثبت',
  'evaluation.list': 'د ارزیابی لیست ',
  'workshop.list': 'د ورکشاپ لیست ',
  'needs.list': 'د نیازسنجی لیست ',
