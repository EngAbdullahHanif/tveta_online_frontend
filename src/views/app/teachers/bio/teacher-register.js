...
const LevelOfEdcationOptions = [
  { value: '14th', label: <IntlMessages id="teacher.EducationLevelOption_1" /> },
  { value: 'bachelor', label: <IntlMessages id="teacher.EducationLevelOption_2" /> },
  { value: 'master', label: <IntlMessages id="teacher.EducationLevelOption_3" /> },
...
const SignupSchema = Yup.object().shape({
  ...
  EnglishName: Yup.string()
    .required(<IntlMessages id="teacher.EnglishNameErr" />),
   
  GrandFatherName: Yup.string()
    .required(<IntlMessages id="teacher.GrandFatherNameErr" />),
  
    TazkiraNo: Yup.string()
    .required(<IntlMessages id="teacher.TazkiraNoErr" />),

      IdCardPageNo: Yup.string()
    .required(<IntlMessages id="teacher.IdCardPageNoErr" />),
      
           IdCardJoldNo: Yup.string()
    .required(<IntlMessages id="teacher.IdCardJoldNoErr" />),
           
    PhoneNo: Yup.string()
    .required(<IntlMessages id="teacher.PhoneNoErr" />),
...
const TeacherRegistration = () => {
  ...
  const initialValues = {
    TazkiraType: { value: '0', label: <IntlMessages id="forms.TazkiraTypeDefaultValue" /> },
    LevelOfEducation: { value: '0', label: <IntlMessages id="forms.TazkiraTypeDefaultValue" /> },
    Status: { value: '0', label: <IntlMessages id="forms.TazkiraTypeDefaultValue" /> },
    Grade: { value: '0', label: <IntlMessages id="forms.TazkiraTypeDefaultValue" /> },
    Step: { value: '0', label: <IntlMessages id="forms.TazkiraTypeDefaultValue" /> },
    Major: { value: '0', label: <IntlMessages id="forms.TazkiraTypeDefaultValue" /> },
    Province: { value: '', label: <IntlMessages id="forms.TazkiraTypeDefaultValue" /> },
    C_Province: { value: '', label: <IntlMessages id="forms.TazkiraTypeDefaultValue" /> },
                ...
                {isNext ? (
                  <Row>
                    <Colxx xxs='6'>
                      ...
                      <Field className="form-control" name="IdCardPageNo" type='number' />
                      ...
                      <Field className="form-control" name="PhoneNo" type= 'number' />
                    ...
                    <Colxx xxs='6'>
                      ...
                      <Field className="form-control" name="GrandFatherName" />
                    ...
                    <FormGroup className="form-group has-float-label">
                      ...
                      <Field className="form-control" name="TazkiraNo" type= 'number'/>
                      ...
                      <Field className="form-control" name="IdCardJoldNo" type='number' />
